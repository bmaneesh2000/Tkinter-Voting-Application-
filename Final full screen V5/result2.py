...
def load_votes():
    ...
    return {'cone': 0, 'ctwo': 0, 'cthree': 0, 'cfour': 0, 'cfive': 0}
...
def load_images():
    try:
        ...
        return photo1, photo2, photo3, photo4, photo5, tie_photo
...
# Load images
photo1, photo2, photo3, photo4, photo5, tie_photo = load_images()

# Determine the winners and losers for each election
votes1 = {'SP1': cone, 'SP2': ctwo, 'SP3': cthree}
...
if len(tied_candidates1) > 1:
    ...
    for candidate in tied_candidates1:
        tie_image_label1 = tk.Label(page1, image=(photo1 if candidate == 'SP1' else photo2 if candidate == 'SP2' else photo3))
...
if len(tied_candidates2) > 1:
    ...
    for candidate in tied_candidates2:
        tie_image_label2 = tk.Label(page2, image=(photo4 if candidate == 'ASP1' else photo5))
    ...
    winner2_image_label = tk.Label(page2, image=(photo4 if winner2_name == 'ASP1' else photo5))
